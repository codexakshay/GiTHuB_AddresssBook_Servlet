	...
	<div class="row">
			...
			<form action="#" method="post">
				<div>
					<h3 style="margin-left: 15%;">
						<label>NEW USER DATA</label>
					</h3>
				</div>
				<input type="text" class="form-control" name="FirstName"
					placeholder="First Name"
					pattern="^([A-Za-z]+[,.]?[ ]?|[A-Za-z]+['-]?)+$" required /><br>
				...
				<input type="text" class="form-control" name="MobileNumber"
					placeholder="Mobile Number" pattern="^((\+91)?|91)?[789][0-9]{9}"
					required /><br> <input type="text" class="form-control"
					name="UserState" placeholder="User State"
					pattern="^([A-Za-z]+[,.]?[ ]?|[A-Za-z]+['-]?)+$" required /><br>
				...
				<input type="text" class="form-control" name="UserPinCode"
					placeholder="User Zip Code" pattern="([0-9]{6}|[0-9]{3}\s[0-9]{3})"
					required /><br> <input type="text" class="form-control"
					id="resizer" name="UserStreet" placeholder="Street" required /><br>

				<input type="submit" id="AddUserDetails" name="AddUserDetails"
					value="ADD" class="block" /> &nbsp; <input type="reset"
					id="ClearUserDetails" style="margin-bottom: 5%;"
					name="ClearUserDetails" value="CLEAR" class="block" />
			</form>
		</div>
		...
		<div class="col-sm-6">
			...
			<div class="panel-body">
				<div>
					...
					<table id="AddressBook"
						class="table table-responsive table-striped table-bordered table-sm"
						cellpadding="0" style="width: 100%">
						<thread>
						<th colspan="4" class="th-sm">Personal Information</th>
						<th colspan="4" class="th-sm">Location Information</th>
						<th colspan="4" class="th-sm">Actions</th>
						<tr>
						...
						<tr>
							...
							<td><a
								href="AddressBookDataEdit.jsp?first_name=<%=first_name%>"><input
									type="button" bgcolor="Blue" id="EditDetails"
									name="EditDetails" value="EDIT" /></a></td>
							<td><a
								href="AddressBookDataRemove.jsp?first_name=<%=first_name%>"><input
									type="button" bgcolor="Red" id="RemoveDetails"
									name="RemoveDetails" value="REMOVE" /></a></td>
						</tr>
						<% 
														}
														%> </thread>
			...
			<div style="margin-left: 10%;">
				<form action="#" method="post">
					<h3 style="margin-left: 19%;">
						<label>VIEW ANY ADDRESS BOOK </label>
					</h3>
					<input type="text" class="form-control" name="SearchAddressBook"
						placeholder="ADDRESS BOOK NAME"
						pattern="^([a-z_]+[,.]?[ ]?|[a-z_]+['-]?)+$" /><br> <input
						type="submit" id="viewAddressBook" name="viewAddressBook"
						value="VIEW" class="block" /><br>
					<br>
				</form>
			</div>
			...
			<div class="">
				<div>
					<form action="UserBookCreateStart.jsp" method="post">
						...
						<input type="submit" id="CreateNewBook" name="CreateNewBook"
							value="CREATE" class="block" /><br>
						<br>
					</form>
				</div>
				...
				<div>
					<form action="UserBookInsertAll.jsp" method="post">
						<h4>
							<label>INSERT INTO ADDRESSS BOOK</label>
						</h4>

						<input type="submit" id="insertTemp" name="insertTemp"
							value="INSERT" class="block" /><br>
						<br>
					</form>
				</div>
				...
				<div>
					<form action="UserBookDropStart.jsp" method="post">
						<h3>
							<label>DELETE ADDRESS BOOK</label>
						</h3>
					...
					<div>
					<form action="UserBookSearchFinish.jsp" method="post">
						<h3>
							<label>SEARCH BOOK BY CITY</label>
						</h3>

						<input type="submit" name="SearchBook" value="SERACH"
							class="block"><br>
						<br>
					</form>
				</div>
